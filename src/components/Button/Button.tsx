...
export const Button = <T extends React.ElementType = 'button'>({
  ...
  return (
    <Tag
      {...rest}
      className={`text-lg font-serif font-bold leading-none py-4 px-10 border-2 bg-transparent transition-all text-center text-grey-800 dark:text-white inline-block ${
        variant === 'primary'
